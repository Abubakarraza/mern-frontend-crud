    ...
    return (
        ...
        <>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-12">
                            ...
                            <input style={{ marginTop: "12px" }} onChange={(e) => setphone(e.target.value)} type="text" className="form-control" placeholder="Email" value={phone} required />
            ...
            {status && 
             ...
             <SpinnerDotted style={{marginBottom:"12px"}} size={30} thickness={180} speed={105} color="rgba(57, 165, 172, 1)" /> 
            }</div>
